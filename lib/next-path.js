...
export function folderPaths(directory) {
    ...
    let directoryPath = path.join(process.cwd(), directory);
    console.log('Primary path:', directoryPath);
    console.log('Primary path exists:', fs.existsSync(directoryPath));
    ...
    if (!fs.existsSync(directoryPath)) {
        ...
        for (const fallbackPath of fallbackPaths) {
            ...
            if (fs.existsSync(fallbackPath)) {
                ...
                console.log('Found at fallback path:', directoryPath);
                break;
            }
        }
    }
