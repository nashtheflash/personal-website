...
export function ContactUs() {
    ...
    return (
        <div className="mx-auto w-full md:p-10 py-5 md:py-0">
            <h2 className={`text-center text-2xl sm:text-6xl ${didot.className} text-primary-content`}>Work With Us</h2>
            <div className="w-full mt-2 sm:mt-5">
                <div className="flex flex-col gap-5 w-full">
                    <div className="flex flex-col md:flex-row  gap-3 w-full">
                        <label 
                            className="group input input-bordered flex items-center gap-2 w-full md:w-1/2 font-serif text-primary-content border border-indigo-900 bg-opacity-0 bg-black rounded-xl shadow-sm has-[:focus]:bg-opacity-20 hover:bg-opacity-20 hover:shadow-md transition-all duration-200"
                        >
                            <FontAwesomeIcon icon={faSignature} className='h-5 w-5'/>
                            <input 
                                type="text" 
                                placeholder="First Name" 
                                className={`grow text-primary-content placeholder:text-primary-content placeholder:${didot.className}`}
                            />
                        </label>
                        <label 
                            className="group input input-bordered flex items-center gap-2 w-full md:w-1/2 font-serif text-primary-content border border-indigo-900 bg-opacity-0 bg-black rounded-xl shadow-sm has-[:focus]:bg-opacity-20 hover:bg-opacity-20 hover:shadow-md transition-all duration-200"
                    ...
                    <textarea
                        ...
                        className={`group input input-bordered text-primary-content placeholder:text-primary-content placeholder:${didot.className} flex items-center gap-2 font-serif text-primary-content border border-indigo-900 bg-opacity-0 bg-black rounded-xl shadow-sm has-[:focus]:bg-opacity-20 hover:bg-opacity-20 hover:shadow-md transition-all duration-200`}
                    >
                    </textarea>
