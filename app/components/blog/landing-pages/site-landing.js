...
import stravaLogo from "@/public/logos/strava.png";
...
export function SocialMedia() {
    const links = {
        github: 'https://github.com/nashtheflash',
        instagam: 'https://www.instagram.com/nashtheflash/',
        linkedin: 'https://www.linkedin.com/in/nashbostwick/',
        strava: 'https://www.strava.com/athletes/111233131',
        youtube: 'https://www.youtube.com/@wiredwoodsman',
    }
    return(
        <div className='flex flex-col w-full h-full px-2 py-1 bg-base-100 rounded-md'>
            ...
            <div className='flex justify-between items-center gap-6'>
                ...
                {/* Instagram */}
                <a href={links.instagam} target='_blank'>
                    <span className="[&>svg]:h-full [&>svg]:w-full [&>svg]:max-h-48 [&>svg]:max-w-48">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
                ...
                {/* Strava */}
                <a href={links.strava} target='_blank'>
