...
export const metadata = generateMetadata({
    title:"ZoomInfo AI Email Review",
    description:"This is an indepth review of the ZoomInfo AI email writing feature",
    keywords: ['ZoomInfo', 'AI email', 'review', 'Nash Bostwick']
});

# ZoomInfo AI Email Review
