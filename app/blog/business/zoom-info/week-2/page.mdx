...
export const metadata = generateMetadata({
    title:"Week Two Using ZoomInfo",
    description:"Implementaion is in progress!! Well, maybe....",
    keywords: ['ZoomInfo', 'review', 'week two', 'implementaion', 'Nash Bostwick']
});

# ZoomInfo Week Two Implementation
...
## Day Two
We had another call with a product specialist. Out of all of the people that I have meet, she was probably the most knowledgeable about the product. We focused on the AI email feature, and while we were able to improve the emails, they still are not very good. If you want to read about the features look at my AI email review here: <LinkNewTab text='ZoomInfo AI Email Review' link='/blog/business/zoom-info/ai-email-review'/>. The most concerning thing is that some of the data we looked at was still incorrect. We will continue working on it!

## Day Three
This was the first day that I was trying to contact people and here are the stats:
* Emails Send: 142
* Emails Bounced: 14
* Email Responses: 1  
* Calls Made: 33
