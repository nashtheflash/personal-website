...
import tempSensor from "@/public/blog/tune-cold-weather-performance/temp-sensor.JPEG";
...
#### Heating Blanket
If you were wanting to have a warm bed when you get in. I would look at a [heating blanket][6]. That made a huge difference for me. I placed the blanket below the comforter and turn it on the lowest heat setting!
