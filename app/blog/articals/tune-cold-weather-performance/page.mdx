...
Difference between ambient and camper temp was kept at 40 degrees which was impressive, but you can also see that the heater ran almost continuously. During the 9 hour test, the heater was only off for 2.5 hours. Kicking on about 10 times. This doesn't sound like much, but when the heater kicks on it it supper loud!

You can download the data here -> <a href={'/blog/tune-cold-weather-performance/No Insulation Data.xlsx'} download>Download</a>

### Tune with Insulation Kit WORKING
<TwoColumn>
This test is heating the camper from ambient temperature to 65 degrees. The camper has the insulation kit installed, no roof insulation, the windows closed, and using the boost setting on the heater. You can see the setup on the right.
<CenteredImage image={insideCamper} altText={'Inside Camper Windows Closed'} title={'3 Corners'} width={700} height={700} />
</TwoColumn>

<LineGraph title={'Ambient to 65 Degrees(empty)'} data={noRoofInsulationInsulationPackDataTimeToTemp} />

It took about 60 minutes to get the camper up to temperature. Defiantly faster than without the kit installed. Without the insulation kit installed, the camper can get drafty due to all the zippers and opening. The insulation kit eliminates the drafts making it much more comfortable! As you can see, the heater is still kicking on an off a decent amount!

<LineGraph title={'Overnight Heater Performance'} data={noRoofInsulationInsulationPackData} />

You can download the data here -> <a href={'/blog/tune-cold-weather-performance/No Insulation Data.xlsx'} download>Download</a>

### Tune with Roof Insulation WORKING

<TwoColumn>
 This test is wit the roof insulation only with the windows closed. The heater is turned on Boost to get the camper to temp, then auto for the rest of the night. You can see the setup on the right.
<CenteredImage image={insideCamper} altText={'Inside Camper Windows Closed'} title={'3 Corners'} width={700} height={700} />
</TwoColumn>
...
### Tune with Insulation Kit & Roof Insulation WOKRING
<TwoColumn>
...
This is by far the best setup. It is not only warm, but it also makes the camper feel like a den. It is dark, quiet, and there are not drafts that are able to get it. Even when it is cold, the night setting on the heater is warm enough to keep the camper warm. Having the heater in night mode is a huge deal because it is very quite! I wake up every time I hear the heater kick on when it is on auto mode!
