...
import insideCamperNoInsulation from "@/public/blog/tune-cold-weather-performance/inside-camper.JPEG";
import insideCamperRoofInsulation from "@/public/blog/tune-cold-weather-performance/insideCamperRoofInsulation.JPEG";
import insideCamperFullInsulation from "@/public/blog/tune-cold-weather-performance/inside-camper-full-insulation.JPEG";
...
<CenteredImage image={insideCamperNoInsulation} altText={'Inside Camper Windows Closed'} title={'3 Corners'} width={700} height={700} />
</TwoColumn>
...
<CenteredImage image={insideCamperRoofInsulation} altText={'Inside Camper Windows Closed'} title={'3 Corners'} width={700} height={700} />
</TwoColumn>
...
<CenteredImage image={insideCamperFullInsulation} altText={'Inside Camper Windows Closed'} title={'3 Corners'} width={700} height={700} />
</TwoColumn>
