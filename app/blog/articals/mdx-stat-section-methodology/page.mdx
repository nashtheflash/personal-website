...
export const postMetadata = {
    title: "MDX Stat Section Methodology",
    published: "2024-12-01",
    updated: "2024-12-01",
    author: 'Nash Bostwick',
    thumbnail: '/blog/artical-template/thumbnail.JPEG',
    description:"How structure a MDX blog for maximum flexability and customizability.",
    keywords: ['MDX', 'Component', 'MDX Higher Order Component', 'MDX Blog Methodology'],
