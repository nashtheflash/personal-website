export const metadata = {
    ...
    description:"WiredWoodsman project summary. How was the blog build. What is the the purpose of the writing.",
...
## Name
Inspired by a coffee shop that was in Rapid City, South Dakota. I'm not sure why the name stuck but it did! The Coffee shops has since went out of business, and I have started using the name!
...
### Database
There is currently no backed(there are Nextjs server functions and API routes) or database. It is 100% static. There are some files that contain data that might look awfully similar to a noSQL database but that is just complexity. I want to model the data very quickly and at the end of the day it is static. At some point if the need arises I am open to adding a database.
### Cool Stuff
I lied above, there is more at play at certain parts of the application. For instance, take a look at the below simple guessing game:
<div className='col-span-3 row-span-2 bg-base-100 rounded-md'>
    <RustChapter2/>
</div>
Super simple? It could be, but this small exersice might look familar to you. This is part of 'the book' of Rust. In fact it is actually Rust code that is being ran on the server. This is what I love about this tech stack, you can simply write simple blog posts that contain words of pictures or embed games that use rust for all of the logic. This ability really sets this website apart!

You may have caught me dancing around how this works. It uses React code for the UI and utilizes and API route, that runs rust code, to get the numbers and check the guesses. You can read more about the project here:
* [Rust Chapter 2][6]
* [All Rust Projects][7]
...
[6]: /blog/articals/rust-chapter-2
[7]: /blog/articals/rust-all-projects
