export const metadata = {
    ...
    tags: ['Tune M1', 'Insulation Pack', 'Install', 'How to'],
    isActive: false,
};
...
import gap from "@/public/blog/tune-insulation/gap.JPEG";
import noGap from "@/public/blog/tune-insulation/no-gap.JPEG";


<MdxLayout>

## How to install tune insulation pack
The official instructions -> <a href="/blog/tune-insulation/tune-insulation-pack-install.pdf" download>Tune Insulation Pack Instructions</a>
I was able to follow the PDF instructions in the Aspen parking lot and everything went great first shot!

For some more detail, there are two basic steps:
...
At first, I though this was due to the roof insulation that I added, and is installed in the both of the above pictures. I also saw people on the [Tune Facebook Page][1] talking about the matres and or sheets contributing to the gap. With the roof down, I was able to feel around between the mattress and the roof and it didn't feel all that tight. I removed the mattress and was able to immediately see that there was enough room, and the roof was not closing. I contacted Tune, and here was the recommendation:
