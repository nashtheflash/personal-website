...
export const metadata = generateMetadata({
    title:"Feline Review",
    description:"How are people getting a cool status line in Neovim? A complete review of the NeoVim plugin, feline. This is part of my series of trying out and reviewing Vim and NeoVim plugins",
