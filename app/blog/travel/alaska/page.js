...
const topics = [
    <TopicSmall key={1}  title='Artical 1' subheading='this is a sub' picture={artOne} link='/blog/travel/alaska'/>,
    <TopicSmall key={2} title='Artical 2' subheading='this is a sub' picture={artOne} link='/blog/travel/costa-rica'/>
]
