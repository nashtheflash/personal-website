export const lawrenceRiverTrailsData = {
        ...
        mapStartingLat: 38.965305, 
        mapStartingLon: -95.183019,
        mapZoom: 12,
        gpxTracks: [
            {name: 'Main Loop', difficulty: 'easy', url: '/mtn-bike-kc/lawrence-river-trails/gpx-files/main-loop.gpx', active: 1, oneWay: false, description: 'Fun fast trail.', features: 'skinnys', mustRide: true, rating: 4},
            {name: 'Sugar Loop', difficulty: 'easy', url: '/mtn-bike-kc/lawrence-river-trails/gpx-files/sugar-loop.gpx', active: 1, oneWay: false, description: 'Fun fast trail.', features: 'skinnys', mustRide: true, rating: 4},
        ],
        photos: [
