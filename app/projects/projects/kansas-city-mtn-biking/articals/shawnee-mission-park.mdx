...
import pumpTrack from "@/public/mtn-bike-kc/sm-park/pump-track.JPEG";
...
### Pump Track
When I was in Kansas City the pump track was being redone. When the lines are done, this will be some of the best riding in the city!

<CenteredImage image={pumpTrack} altText={'Shawnee Mission Park Pump Track'} title={'East Entrance'} width={'h-2/3'} height={'w-2/3'} />
