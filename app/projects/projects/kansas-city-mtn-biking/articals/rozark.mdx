...
The first thing that you will notice is that the trail goes everywhere with little rhyme or reason. There are arrows posted on some trees that have colors that corespond to the trail map, but these are few and far between.
